![Header](https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&text=Mohamed%20Amine%20Belfencha&fontSize=45&fontAlign=50&fontAlignY=35&desc=Full-Stack%20Developer%20%7C%20Technical%20Manager&descAlign=50&descAlignY=55)

<div align="center">

[![GitHub followers](https://img.shields.io/github/followers/ameneblf?label=Followers&style=social)](https://github.com/ameneblf)
[![Email](https://img.shields.io/badge/Email-Belfencha.ma%40gmail.com-D14836?style=flat&logo=gmail&logoColor=white)](mailto:Belfencha.ma@gmail.com)
...
Full-Stack Developer with **5+ years** of experience building scalable web applications. Currently **Technical Manager & Partner at ERYX MAROC**, specializing in **Laravel + Vue 3** architectures with complex integrations and multi-tenant systems.
...
**Core Expertise:**
- 🏗️ Multi-tenant SaaS architecture (JWT, REST APIs)
- ⚡ Performance optimization & scalability
- 🔄 Complex integrations (Dolibarr, third-party APIs)
...
- 🏗️ Architected **multi-tenant system** with JWT authentication, REST APIs, and MySQL
- 📊 Built **SaaS modules**: invoicing, inventory management, association management
- 🎨 Developed **Vue 3 + Pinia** frontend with bilingual support (AR/FR)
...
- 🏗️ Developed custom **PHP MVC framework** with Bootstrap
- 📍 Implemented **geolocation features** with proximity filtering
- 🔍 Created dynamic **search & CRUD** system for establishments
- 🎨 Handled full cycle: **UI/UX design → development → production → optimization**
...
Modernized legacy desktop application:
...
- ⚡ Implemented **pagination, validation, role-based access control**
...
- 🔐 Built **authentication** and **Excel import** system (XLSX/CSV)
- 📊 Created **dashboards** with MySQL queries and exports
...
**📚 Additional Training**  
English Language (Intermediate 3) - *ELC Rabat* | 2023-2025
